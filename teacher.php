                    ...
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"> Teacher Name </span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"> Active Teacher </span>
                            </span>
                        </span>
                    </button>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link"  role="button" aria-expanded="false" > Publication</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link"  role="button" aria-expanded="false" > Social Media</a>
                                    </li>
                                    <li class="nav-item">
